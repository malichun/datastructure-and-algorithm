 ...
 *
 * 迪杰斯特拉算法求最短路径
 * Created by John.Ma on 2022/4/2 0002 23:55
 */
...
class Graph{
    ...
    public void dsj(int index){
        ...
        update(index); // 更新index顶点到周围顶点的距离 和 前驱顶点
    ...
    private void update(int index){
        ...
        for(int j=0;j<matrix[index].length;j++){
            // len 含义是:出发顶点 到 index顶点的距离 + 从index顶点到j顶点的距离的和
...
class VisitedVertex{
    ...
    private int[] dis;
    private List<LinkedList<Integer>> path;

    /**
     * 构造器
     * @param length 顶点的个数
     * @param index 出发顶点对应的下标 (比如G为顶点,下标为6)
     */
    ...
    public void show(){
        System.out.println("==================================");
        // 输出already_arr
        Arrays.stream(already_arr).forEach(i -> System.out.print(i + " "));
        System.out.println();
        System.out.println("==================================");
        // 输出前驱顶点(最后一次)
        Arrays.stream(pre_visited).forEach(i -> System.out.print(i + " "));
        System.out.println();
        System.out.println("==================================");
